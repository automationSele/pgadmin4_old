  ...
  _.extend(pgAdmin.Browser, {
    ...
    panels: {
      ...
      'statistics': new pgAdmin.Browser.Panel({
        ...
        isCloseable: false,
        isPrivate: true,
        content: '<div class="negative-space p-2"><div class="alert alert-info pg-panel-message pg-panel-statistics-message">' + select_object_msg + '</div><div class="pg-panel-statistics-container card d-none"></div></div>',
        events: panelEvents,
      }),
      ...
      'dependencies': new pgAdmin.Browser.Panel({
        ...
        isCloseable: false,
        isPrivate: true,
        content: '<div class="negative-space p-2"><div class="alert alert-info pg-panel-message pg-panel-depends-message">' + select_object_msg + '</div><div class="pg-panel-depends-container card d-none"></div></div>',
        events: panelEvents,
      }),
